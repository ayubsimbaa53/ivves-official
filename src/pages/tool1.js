      ...
      <div className="relative m-auto  w-[340px] sm:w-[480px] md:w-[490px] lg:w-[800px]">
        ...
        {active && (
          <div className="absolute  w-full sm:right-[-70px] sm:top-5 sm:w-[200px] md:right-[-125px] md:top-[100px]  md:w-[235px] lg:right-[-98px] lg:top-[175px] lg:w-[280px] xl:right-[-122px] xl:w-[300px]">
            ...
            >
              <IoClose className="text-sm dark:text-black font-bold md:text-[20px]" />
            </div>
            {active === "tool-one" && (
              <div className="flex w-full flex-col gap-4">
                <div className="dark:bg-[#131B2D] dark:text-white flex w-full items-center justify-between rounded-[6px] bg-white py-[6px] px-4 shadow-sm">
                  <p className=" text-xs md:text-sm lg:text-base dark:text-white">
                    Tool Name 1
                  </p>
                  <div>
            ...
            {active === "tool-two" && (
              <div className="flex w-full flex-col gap-4 ">
                <div className="flex w-full items-center justify-between dark:bg-[#131B2D] rounded-[6px] bg-white py-2 px-4 shadow-sm">
            ...
            {active === "tool-three" && (
              <div className="flex w-full flex-col gap-4">
                <div className="flex w-full dark:bg-[#131B2D] dark:text-white items-center justify-between rounded-[6px] bg-white py-2 px-4 shadow-sm">
            ...
            {active === "tool-four" && (
              <div className="flex w-full flex-col gap-4">
                <div className="flex w-full items-center dark:bg-[#131B2D] dark:text-white justify-between rounded-[6px] bg-white py-2 px-4 shadow-sm">
            ...
            {active === "tool-five" && (
              <div className="flex w-full flex-col gap-4">
                <div className="flex w-full items-center justify-between dark:bg-[#131B2D] dark:text-white rounded-[6px] bg-white py-2 px-4 shadow-sm">
